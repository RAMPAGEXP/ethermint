...
import (
	...
	"github.com/RAMPAGEXP/ethermint/indexer"
	"github.com/RAMPAGEXP/ethermint/rpc/backend/mocks"
	rpctypes "github.com/RAMPAGEXP/ethermint/rpc/types"
...
func (suite *BackendTestSuite) SetupTest() {
	...
	clientDir := filepath.Join(baseDir, nodeDirName, "rxpcli")
