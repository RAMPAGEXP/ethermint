let
  pkgs = import ../../../nix { };
  fetchEthermint = rev: builtins.fetchTarball "https://github.com/RAMPAGEXP/ethermint/archive/${rev}.tar.gz";
  released = pkgs.buildGo118Module rec {
    name = "ethermintd";
    # the commit before https://github.com/RAMPAGEXP/ethermint/pull/943
