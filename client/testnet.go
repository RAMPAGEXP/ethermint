...
import (
	...
	"github.com/RAMPAGEXP/ethermint/crypto/hd"
	"github.com/RAMPAGEXP/ethermint/server/config"
	...
	"github.com/RAMPAGEXP/ethermint/testutil/network"
)
...
Example:
	rxpd testnet init-files --v 4 --output-dir ./.testnets --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "rxpd", "Home directory of the node's daemon configuration")
...
Example:
	rxpd testnet --v 4 --output-dir ./.testnets
	`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			args := startArgs{}
			args.outputDir, _ = cmd.Flags().GetString(flagOutputDir)
